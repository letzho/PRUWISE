...
var help = () => `
  ...
  ${import_chalk.default.gray("\u2013")} Show the 5 latest Vercel product updates

    ${import_chalk.default.cyan(`$ ${packageName} --changelog`)}

  ${import_chalk.default.gray("\u2013")} Search Vercel product updates

    ${import_chalk.default.cyan(`$ ${packageName} changelog search "AI SDK"`)}
`;
