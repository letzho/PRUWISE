...
import {
  metricsCommand
} from "./chunk-MTWHQEXI.js";
import {
  routesCommand
} from "./chunk-POOO7W47.js";
import {
  commentsCommand
} from "./chunk-SLPSPYVR.js";
import {
  activityCommand
} from "./chunk-4KD5BYHB.js";
import {
  alertsCommand
} from "./chunk-DWIC7MRV.js";
import {
  devCommand
} from "./chunk-XDGOOW3K.js";
import {
  listCommand
} from "./chunk-VP5Y3SZG.js";
import {
  buildCommand,
  pullCommand
} from "./chunk-FWKSJYDV.js";
import {
  envCommand
} from "./chunk-FXD67VN5.js";
import {
  confirmOption,
  deploymentOption,
  forceOption,
...
var deployCommand = {
  name: "deploy",
  aliases: [],
  description: "Deploy your project to Vercel. Use `--temporary` to create a temporary deployment without logging in. The `deploy` command is the default command for the Vercel CLI, and can be omitted (`vc deploy my-app` equals `vc my-app`). Use `--dry` to inspect the detected framework preset and source files without deploying.",
  arguments: [
    {
      name: "project-path",
      required: false
  ...
  options: [
    ...
    },
    {
      ...
      type: Boolean,
      deprecated: false,
      description: "Create a temporary deployment without logging in"
    },
    {
      name: "archive",
      shorthand: null,
...
var createSubcommand = {
  ...
  options: [
    ...
    },
    {
      ...
      type: Boolean,
      deprecated: false,
      description: "Exempt the key from the team's ZDR-only model restriction (team owners only)"
    },
    {
      ...
      type: Boolean,
      deprecated: false,
      description: "Exempt the key from all of the team's restrictions: ZDR-only models, the provider/model allowlist, and the HIPAA and prompt-training filters (team owners only)"
    }
  ],
  examples: [
    {
...
var setupSubcommand = {
  ...
  options: [
    ...
    },
    {
      ...
      type: Boolean,
      deprecated: false,
      description: "Do not copy existing Codex Desktop sessions for use with the Vercel AI Gateway provider."
    },
    {
      name: "no-keychain",
      shorthand: null,
...
var budgetsSetSubcommand = {
  name: "set",
  aliases: [],
  description: "Create or update an AI Gateway budget for a scope (team, project <name>, user <email>, or api-key <name>)",
  arguments: [
...
var budgetsInspectSubcommand = {
  name: "inspect",
  aliases: [],
  description: "Show one AI Gateway budget for a scope (team, project <name>, user <email>, or api-key <name>)",
  arguments: [
    { name: "scope", required: true },
    { name: "name", required: false }
  ],
...
var budgetsRemoveSubcommand = {
  name: "remove",
  aliases: ["rm", "delete"],
  description: "Remove an AI Gateway budget for a scope (team, project <name>, user <email>, or api-key <name>)",
  arguments: [
    { name: "scope", required: true },
    { name: "name", required: false }
  ],
...
var budgetsDefaultsSetSubcommand = {
  name: "set",
  aliases: [],
  description: "Create or update the AI Gateway budget default for a scope (project, api-key, or user), applied to resources of that scope without an explicit budget",
...
var budgetsDefaultsRemoveSubcommand = {
  name: "remove",
  aliases: ["rm", "delete"],
  description: "Remove the AI Gateway budget default for a scope (project, api-key, or user)",
  arguments: [{ name: "scope", required: true }],
  options: [yesOption, formatOption],
  examples: [
    {
...
var budgetsDefaultsSubcommand = {
  name: "defaults",
  aliases: [],
  description: "Manage AI Gateway budget defaults (per-project, per-api-key, and per-member spend limits applied by default)",
  arguments: [],
  subcommands: [
...
// src/commands/changelog/command.ts
...
var createSubcommand2 = {
  ...
  options: [
    ...
    },
    {
      ...
      argument: "PROJECT",
      deprecated: false,
      description: "Target a project by name or ID instead of the linked project. Requires --triggers."
    },
    {
      name: "trigger-path",
      shorthand: null,
      ...
      argument: "PATH",
      deprecated: false,
      description: "Set the path on the destination project that receives forwarded webhooks. Requires --triggers."
    },
    {
      name: "trigger-branch",
      shorthand: null,
      ...
      argument: "BRANCH",
      deprecated: false,
      description: "Target a specific git branch for the trigger destination. Requires --triggers."
    },
    {
      ...
      argument: "ENV",
      deprecated: false,
      description: "Target a custom environment by slug or stable ID. Mutually exclusive with --trigger-branch and requires --triggers."
    },
    {
      ...
      argument: "METHOD",
      deprecated: false,
      description: "How to connect to the service (e.g. oauth, mcp, api-key). Run without it to choose interactively; the error lists the valid values for a service."
    },
    {
      name: "target",
      shorthand: null,
      ...
      argument: "TARGET",
      deprecated: false,
      description: "Which of the service's products to connect to (e.g. api, mcp). Only needed when a service exposes more than one."
    },
    {
      name: "param",
      shorthand: null,
      ...
      argument: "KEY=VALUE",
      deprecated: false,
      description: "Value for a connection method template field (e.g. domain=acme.okta.com). Repeatable."
    },
    {
      ...yesOption,
...
var inspectSubcommand3 = {
  name: "inspect",
  aliases: [],
  description: "Show a DNS record in full using its ID",
  arguments: [
    {
      name: "id",
      required: true
  ...
  examples: [
    {
      ...
      value: `${packageName} dns inspect rec_1a2b3c4d5e6f`
    },
    {
      name: "Show a DNS record as JSON",
      value: `${packageName} dns inspect rec_1a2b3c4d5e6f --json`
    }
  ]
};
...
var updateSubcommand2 = {
  ...
  options: [
    ...
    },
    {
      ...
      argument: "TYPE",
      deprecated: false,
      description: "New type of the DNS record (A, AAAA, ALIAS, CAA, CNAME, MX, SRV, TXT)"
    },
    {
      name: "value",
      shorthand: null,
...
var dnsCommand = {
  ...
  examples: [
    ...
    {
      name: "Update an existing DNS record using its ID",
      value: [
        `${packageName} dns update <ID> --value <VALUE>`,
        `${packageName} dns update rec_1a2b3c4d5e6f --name api --ttl 300`
      ]
    },
    {
      name: "Show a DNS record in full using its ID",
      value: [
        `${packageName} dns inspect <ID>`,
        `${packageName} dns inspect rec_1a2b3c4d5e6f`
      ]
    },
    {
...
var renewSubcommand = {
  name: "renew",
  aliases: [],
  description: "Renew a registered domain before it expires (charges your account)",
  arguments: [
    {
      name: "domain",
      required: true
...
var teamLevelOption = {
  ...
  type: Boolean,
  deprecated: false,
  description: "Operate on the team-level firewall configuration, which applies to every project in the team. No linked project required. Cannot be combined with --project"
};
...
// src/util/flags/attribute-types.ts
var TIMESTAMP_IDENTIFY_HELP = "Pass Timestamp values as epoch milliseconds in identify() / evaluation context";
function isTimestampAttributeType(type) {
  return type === "timestamp";
}
function isBucketingAttribute(attribute) {
  return !isTimestampAttributeType(attribute.type);
}
function getFlagAttributeType(settings, kind, attribute) {
  return settings?.entities.find((entity) => entity.kind === kind)?.attributes.find((candidate) => candidate.key === attribute)?.type;
}
...
var TIMESTAMP_FLAG_CONDITION_COMPARATOR_LABELS = {
  gt: "is after",
  gte: "is on or after",
  lt: "is before",
  lte: "is on or before"
...
function formatFlagConditionComparator(comparator, options) {
  const timestampLabel = options?.attributeType === "timestamp" ? TIMESTAMP_FLAG_CONDITION_COMPARATOR_LABELS[comparator] : void 0;
  const label = timestampLabel ?? FLAG_CONDITION_COMPARATOR_LABELS[comparator] ?? LEGACY_FLAG_CONDITION_COMPARATOR_LABELS[comparator] ?? comparator;
...
var useTargetingSubcommand = {
  name: "use-targeting",
  aliases: [],
  description: "Enable targeting for a feature flag environment; keeps the current fallthrough unless --default-variant is set",
  arguments: [
    {
      name: "flag",
      required: true
  ...
  options: [
    projectOption,
    {
      ...
      type: String,
      deprecated: false,
      description: "The environment to enable targeting in (production, preview, or development)",
      argument: "ENV"
    },
    {
      ...
      type: String,
      deprecated: false,
      description: "Replace the fallthrough with this variant when no targeting rules match",
      argument: "VARIANT"
    },
    {
      name: "message",
...
var PROJECT_GRANT_POLICY_KIND = "project-grant";
function isProjectGrant(policy) {
  return policy.kind === PROJECT_GRANT_POLICY_KIND;
}
function issuerUrl(issuerId) {
  return `https://kms.vercel.com/${issuerId}`;
}
function issuerJwksUrl(issuerId) {
  return `${issuerUrl(issuerId)}/jwks.json`;
}

// src/commands/kms/command.ts
var cursorOption = {
  name: "next",
  shorthand: null,
  type: String,
  argument: "CURSOR",
  deprecated: false,
  description: "Show the next page of results, using a cursor from a prior page"
};
var algorithmOption = {
  name: "algorithm",
  shorthand: "a",
...
var claimsSchemaOption = {
  name: "claims-schema",
  shorthand: null,
  type: String,
  argument: "JSON",
  deprecated: false,
  description: "JSON Schema validating token claims, as inline JSON, `@<file>`, or `@-` for stdin"
};
var removeClaimsSchemaOption = {
...
var tokenClaimsOption = {
  name: "token-claims",
  shorthand: null,
  type: String,
  argument: "JSON",
  deprecated: false,
  description: "Claims to include in tokens signed for this grant, as inline JSON, `@<file>`, or `@-` for stdin"
};
var removeTokenClaimsOption = {
...
var environmentOption2 = {
  ...
  argument: "ENV",
  deprecated: false,
  description: "Environment the grant applies to: a system environment (production, preview, development) or a custom environment ID (env_\u2026). Repeatable"
};
var keyOption = {
  name: "key",
  shorthand: "k",
  ...
  argument: "FILE",
  deprecated: false,
  description: "Path to the PEM private key to import, or `-` to read it from stdin"
};
var keyIdOption = {
  name: "key-id",
  shorthand: null,
...
var revokePreviousAfterHoursOption = {
  name: "revoke-previous-after-hours",
  shorthand: null,
  type: Number,
  argument: "HOURS",
  deprecated: false,
  description: "Hours the previous key keeps verifying after activation (default: 1)"
};
var activationOption = {
  ...
  argument: "MODE",
  deprecated: false,
  description: "When the key starts signing: automatic or manual (default: automatic)"
};
function skipConfirmationOption(action) {
  return {
    ...yesOption,
...
var sandboxRegionOption = {
  name: "sandbox-region",
  shorthand: null,
  type: String,
  argument: "REGION",
  description: 'Set the default region for sandboxes created in the project. See the Vercel docs for available regions. Use "" to clear',
  deprecated: false
};
var sandboxFailoverRegionsOption = {
  name: "sandbox-failover-regions",
  shorthand: null,
  type: String,
  argument: "REGIONS",
  description: 'Set the ordered, comma-separated failover regions for sandboxes created in the project. Requires a primary region and must not include it. Use "" to clear',
  deprecated: false
};
var addSubcommand9 = {
  name: "add",
...
var pauseSubcommand = {
  name: "pause",
  aliases: [],
  description: "Pause production traffic for a project (visitors will see an error page)",
  arguments: [
    {
      name: "project",
      required: false
...
var updateSubcommand7 = {
  ...
  options: [
    ...
    },
    {
      ...
      type: String,
      argument: "TIER",
      description: "Set the default function CPU/memory tier: standard_legacy, standard, performance, or performance_xl",
      deprecated: false
    },
    sandboxRegionOption,
    sandboxFailoverRegionsOption,
    {
      ...
      type: String,
      argument: "TYPE",
      description: "Set the build machine type: basic, standard, enhanced, turbo, or elastic",
      deprecated: false
    },
    {
    ...
    },
    {
      ...
      type: String,
      argument: "VERSION",
      description: "Set the Node.js version: 24.x, 22.x, 20.x, 18.x, 16.x, 14.x, 12.x, or 10.x",
      deprecated: false
    },
    {
      ...yesOption,
      description: "Apply settings that do not affect charges without prompting"
    },
    formatOption,
    jsonOption
  ],
...
var membersRemoveFlags = [formatOption, jsonOption];
var PROJECT_MEMBER_ROLES = [
  "ADMIN",
  "PROJECT_DEVELOPER",
  "PROJECT_VIEWER",
  "PROJECT_GUEST"
];
var memberRoleOption = {
  name: "role",
  shorthand: null,
  type: String,
  argument: "ROLE",
...
var checkSubcommand2 = {
  name: "check",
  aliases: [],
  description: "Run the security checks for the current team and show each check with its risk level, status, violation count, and muted findings. Pass check slugs to compute only those checks and list their findings",
  default: true,
  arguments: [
    {
      name: "check",
  ...
  options: [
    {
      ...
      type: Boolean,
      deprecated: false,
      description: "List individual findings under each check, including muted ones. Implied when a check slug is passed"
    },
    {
      name: "limit",
      shorthand: null,
      ...
      argument: "N",
      deprecated: false,
      description: "Max findings listed per check; by default every available finding is listed. Violation counts are always exact even when findings are capped"
    },
    {
      ...projectOption,
      shorthand: "p",
...
var tokensCommand = {
  ...
  arguments: [],
  subcommands: [addSubcommand12, listSubcommand19, removeSubcommand15],
  options: [],
  examples: []
};
