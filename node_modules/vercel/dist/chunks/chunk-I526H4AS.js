...
function buildCommandDocumentationLines(command, options) {
  ...
  return outputArrayToString([
    `${INDENT}${import_chalk.default.dim(`${documentation.label}:`)}`,
    "",
    lineToString([INDENT, INDENT, import_chalk.default.cyan(documentation.url)]),
    ""
  ]);
}
...
export {
  buildCommandDocumentationLines,
  help
};
