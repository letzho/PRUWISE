...
var CREDENTIAL_STORE_CONFLICT = /already exists in the keychain|errSecDuplicateItem/i;
...
async function engineLogout(engine, registry) {
  await (0, import_execa.default)(engine, ["logout", registry], {
    reject: false,
    stdio: "ignore"
  });
}
