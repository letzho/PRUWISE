...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-XINES6PL.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-BKSHWTPX.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-7XACNZ2U.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-IYGWCNXT.js")).default(client, argv, telemetry);
    default:
