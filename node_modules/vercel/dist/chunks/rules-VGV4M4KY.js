...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-RNGO257R.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-RNGO257R.js")).default(client, args);
    case "schema":
      return (await import("./schema-45SJNY5L.js")).default(client, args);
    case "add":
      return (await import("./add-RBW7QITR.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-ZSTDDFID.js")).default(client, args);
    case "rm":
      return (await import("./rm-5B5VHWWN.js")).default(client, args);
    case "update":
      return (await import("./update-JBQBC3IV.js")).default(client, args);
    default:
