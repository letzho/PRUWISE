...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-NBDX3MKN.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-TWDPMXZ5.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-REJVXALW.js")).default(client, args, telemetry);
    default:
