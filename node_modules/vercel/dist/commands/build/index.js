...
import {
  ...
  writeBuildResult
} from "../../chunks/chunk-TPATD2MM.js";
import {
  importBuilders,
  import_import_builders
} from "../../chunks/chunk-OO3OF6MK.js";
import {
  js_yaml_default,
  pullCommandLogic
} from "../../chunks/chunk-6TBDHUXK.js";
import {
  require_semver
} from "../../chunks/chunk-IB5L4LKZ.js";
import {
  readProjectSettings
} from "../../chunks/chunk-NBW3BWOJ.js";
...
// ../../internals/cli-builder-integration/dist/build-concurrency.js
var require_build_concurrency = __commonJS({
  "../../internals/cli-builder-integration/dist/build-concurrency.js"(exports, module) {
    "use strict";
    ...
    var __toCommonJS = (mod) => __copyProps(__defProp({}, "__esModule", { value: true }), mod);
    var build_concurrency_exports = {};
    __export(build_concurrency_exports, {
      getInstallScopeKey: () => getInstallScopeKey,
      groupIntoScopeChains: () => groupIntoScopeChains,
      resolveBuildConcurrency: () => resolveBuildConcurrency,
      resolveInstallScopeRoot: () => resolveInstallScopeRoot,
      runBuildsWithConcurrency: () => runBuildsWithConcurrency,
      runWithConcurrency: () => runWithConcurrency
    });
    module.exports = __toCommonJS(build_concurrency_exports);
    var import_node_os = __toESM2(__require("os"));
    var import_node_fs3 = __require("fs");
    var import_node_path3 = __require("path");
    var MAX_AUTO_CONCURRENCY = 8;
    function resolveBuildConcurrency(raw = process.env.VERCEL_EXPERIMENTAL_BUILD_CONCURRENCY) {
      const value = raw?.trim();
      if (!value)
        return 1;
      const parallelism = Math.max(
        typeof import_node_os.default.availableParallelism === "function" ? import_node_os.default.availableParallelism() : import_node_os.default.cpus().length,
        1
      );
    ...
    async function runWithConcurrency(items, limit, fn, onSecondaryError) {
      const queue = [...items];
    ...
    function getInstallScopeKey({
      ...
      return JSON.stringify([
        toolchain,
        (0, import_node_path3.normalize)(installDirectory),
        typeof installCommand === "string" ? ["cmd", installCommand.trim()] : "default"
      ]);
    }
    var NODE_LOCKFILES = [
      "pnpm-lock.yaml",
    ...
    async function fileExists(path) {
      try {
        await import_node_fs3.promises.stat(path);
        return true;
      } catch {
        return false;
      }
    }
    var SERVICE_DIR_TOOLCHAINS = /* @__PURE__ */ new Set(["go", "ruby", "rust", "container"]);
    async function resolveInstallScopeRoot({
      toolchain,
      serviceDir,
      ceilingDir
    }) {
      if (toolchain !== "node" && toolchain !== "python") {
        return SERVICE_DIR_TOOLCHAINS.has(toolchain) ? (0, import_node_path3.normalize)(serviceDir) : (0, import_node_path3.normalize)(ceilingDir);
      }
      const ceiling = (0, import_node_path3.normalize)(ceilingDir);
      let dir = (0, import_node_path3.normalize)(serviceDir);
      if (dir !== ceiling && !dir.startsWith(ceiling + import_node_path3.sep)) {
        return dir;
      }
      let nearestLockfileDir;
      let nearestPackageJsonDir;
      let done = false;
      while (!done) {
        if (toolchain === "node") {
          if (nearestLockfileDir === void 0) {
            for (const lockfile of NODE_LOCKFILES) {
              if (await fileExists((0, import_node_path3.join)(dir, lockfile))) {
                nearestLockfileDir = dir;
                break;
              }
            }
          }
          if (await fileExists((0, import_node_path3.join)(dir, "pnpm-workspace.yaml")))
            return dir;
          try {
            const pkg = JSON.parse(
              await import_node_fs3.promises.readFile((0, import_node_path3.join)(dir, "package.json"), "utf8")
            );
          ...
          try {
            const pyproject = await import_node_fs3.promises.readFile(
              (0, import_node_path3.join)(dir, "pyproject.toml"),
              "utf8"
            );
            if (pyproject.includes("[tool.uv.workspace]"))
              return dir;
          } catch {
          }
        }
      ...
      return nearestLockfileDir ?? nearestPackageJsonDir ?? (0, import_node_path3.normalize)(serviceDir);
    }
    async function runBuildsWithConcurrency({
      builds,
      concurrency,
      isEligible,
      resolveScope,
      ...
      if (parallelBuilds.length > 0) {
        ...
        if (forceSingleChain) {
          ...
          siblingsOf = /* @__PURE__ */ new Map();
        } else {
          const scopeByBuild = /* @__PURE__ */ new Map();
        ...
        const activeBuildOfChain = /* @__PURE__ */ new Map();
    ...
    function groupIntoScopeChains(items, scopeOf) {
      const chainByOuter = /* @__PURE__ */ new Map();
      const leaderByInnerByOuter = /* @__PURE__ */ new Map();
      ...
      for (const item of items) {
        ...
        if (!leaderByInner) {
          leaderByInner = /* @__PURE__ */ new Map();
...
var require_constants = __commonJS({
  "../../internals/runtimes/dist/constants.js"(exports, module) {
    "use strict";
    var __defProp = Object.defineProperty;
    var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames = Object.getOwnPropertyNames;
...
var require_framework = __commonJS({
  "../../internals/runtimes/dist/framework.js"(exports, module) {
    "use strict";
    var __defProp = Object.defineProperty;
    var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames = Object.getOwnPropertyNames;
    ...
    var DETECTION_FRAMEWORKS = import_frameworks.frameworkList.filter(
...
// ../../internals/runtimes/dist/runtime.js
var require_runtime = __commonJS({
  "../../internals/runtimes/dist/runtime.js"(exports, module) {
    "use strict";
    var __defProp = Object.defineProperty;
    var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames = Object.getOwnPropertyNames;
...
var require_monorepo = __commonJS({
  "../../internals/cli-builder-integration/dist/monorepo.js"(exports, module) {
    ...
    var import_path2 = __require("path");
    var import_fs_detectors = require_dist3();
    var import_runtime = require_runtime();
    ...
    async function initCorepack({
      ...
      if (isCantParseJSONFile(pkg)) {
        ...
        if (warmPackageManager) {
          try {
            await (0, import_build_utils3.spawnAsync)(pkgManagerName, ["--version"], {
...
var require_do_build = __commonJS({
  "../../internals/cli-builder-integration/dist/do-build.js"(exports, module) {
    ...
    var import_build_concurrency = require_build_concurrency();
    ...
    async function doBuild3(request, dependencies) {
      ...
      const {
        ...
        canBuildInSubprocess: canBuildInSubprocess2,
      ...
      if (sourceConfigFile) {
        corepackShimDir = await (0, import_corepack.initCorepack)({
          ...
          readJSONFile: readJSONFile2,
          isCantParseJSONFile,
          warmPackageManager: (0, import_build_concurrency.resolveBuildConcurrency)() > 1
        });
      ...
      const buildOrdinals = /* @__PURE__ */ new Map();
      const runBuilders = async (buildsToRun) => {
        await addBuildsToBuildJson(buildsToRun);
        const buildOne = async (build, concurrent) => {
          ...
          try {
            ...
            const perBuildEnv = concurrent ? { ...process.env } : process.env;
            const setBuildEnv = (key, value) => {
              if (!concurrent)
                restoreEnv.set(key, process.env[key]);
              if (value === void 0)
                delete perBuildEnv[key];
              else
                perBuildEnv[key] = value;
            };
            ...
            for (const key of [
              ...
              setBuildEnv(envKey, typeof value === "string" ? value : void 0);
            ...
            const apiDirFramework = isApiDir ? await apiDirFrameworkDetector.detect(build.use ?? "", buildWorkPath) : void 0;
            let buildConfig;
            if (isZeroConfig) {
              if (service) {
                buildConfig = {
            ...
            const preDeployEntry = preDeployCmd && service ? {
            ...
            if (concurrent && runner instanceof import_build_runner2.InprocessBuildRunner) {
              throw new Error(
                    ...
                    if (key.endsWith("package-manifest.json")) {
                      try {
                        ...
                        if (validationError) {
                          ...
                          const buildType = packageManifest.buildType ?? (buildConfig.middleware === true ? "middleware" : isApiDir ? "api-dir" : "app");
                          const entry = {
                            ordinal: buildOrdinals.get(build) ?? Number.MAX_SAFE_INTEGER,
                            workspace,
                            key: fullKey,
                          ...
                          const existing = existingIndex === -1 ? void 0 : packageManifests[existingIndex];
                          if (!existing) {
        ...
        const sortedBuilds = (0, import_execute_builder.sortBuildsForExecution)(buildsToRun);
        for (const build of sortedBuilds) {
          if (!buildOrdinals.has(build)) {
            buildOrdinals.set(build, buildOrdinals.size);
          }
        }
        const concurrency = createBuildRunner2 && canBuildInSubprocess2 ? (0, import_build_concurrency.resolveBuildConcurrency)() : 1;
        await (0, import_build_concurrency.runBuildsWithConcurrency)({
          builds: sortedBuilds,
          concurrency,
          isEligible: (build) => {
            const bp = typeof build.src === "string" ? buildersWithPkgs.get(build.use) : void 0;
            return !!bp && !!canBuildInSubprocess2 && canBuildInSubprocess2({
              hasDetectedServices: getHasDetectedServices(),
              builderPath: bp.path
            });
          },
          ...
          forceSingleChain: !hasExperimentalServicesV1ConfiguredInVercelConfig && !hasExperimentalServicesV2ConfiguredInVercelConfig,
          resolveScope: async (build) => {
            const service = getHasDetectedServices() && typeof build.src === "string" ? serviceByBuilder.get(build) : void 0;
            if (!service) {
            ...
            const serviceWorkspace = (0, import_build_utils3.isExperimentalService)(service) ? service.workspace : service.root;
            const serviceDir = serviceWorkspace && serviceWorkspace !== "." ? (0, import_path2.join)(workPath, serviceWorkspace) : workPath;
            const toolchain = service.runtime ?? ["python", "go", "ruby", "rust", "container"].find(
              (t) => build.use.startsWith(`@vercel/${t}`)
            ) ?? "node";
            const customInstall = Boolean(service.installCommand?.trim());
            const installRoot = await (0, import_build_concurrency.resolveInstallScopeRoot)({
              toolchain,
              serviceDir,
            ...
            return {
              ...
              innerKey: (0, import_build_concurrency.getInstallScopeKey)({
                toolchain,
      ...
      const sortBuildResultsByOrdinal = () => {
        const orderedResults = Array.from(buildResults.entries()).sort(
          ([a], [b]) => (buildOrdinals.get(a) ?? Number.MAX_SAFE_INTEGER) - (buildOrdinals.get(b) ?? Number.MAX_SAFE_INTEGER)
        );
        buildResults.clear();
      ...
      const orderedServiceCrons = synthesizedServiceCrons.slice().sort((a, b) => a.ordinal - b.ordinal).map((entry) => entry.cron);
      ...
      const orderedOverrides = overrides.slice().sort((a, b) => a.ordinal - b.ordinal).map((entry) => entry.override);
      const mergedOverrides = overrides.length > 0 || topLevelBuildResultOverrides.length > 0 ? Object.assign({}, ...orderedOverrides, ...topLevelBuildResultOverrides) : void 0;
...
function mergeWorkerMeta(target, workerMeta) {
...
function createServiceLinePrefixer(serviceName, dest) {
...
var SubprocessBuildRunner = class extends import_build_runner.BuildRunner {
  ...
  async build() {
    ...
    const child = fork(workerPath, [], {
      ...
      stdio: serviceName ? ["inherit", "pipe", "pipe", "ipc"] : ["inherit", "inherit", "inherit", "ipc"]
    });
    this.child = child;
    this.stdoutPrefixer = serviceName ? createServiceLinePrefixer(serviceName, process.stdout) : void 0;
    this.stderrPrefixer = serviceName ? createServiceLinePrefixer(serviceName, process.stderr) : void 0;
