...
import {
  ...
  setAutoUpdate,
  tryOpenApiFallback
} from "./chunks/chunk-ONRLTUP2.js";
import "./chunks/chunk-FGDKMNEN.js";
import {
  getUpdateCommand
} from "./chunks/chunk-WA2SJE5S.js";
import {
...
import "./chunks/chunk-I526H4AS.js";
import {
  getLinkFromDir,
  getScope,
  getTeamByIdOrSlug,
...
`);
  ...
  if (targetOrSubcommand) {
    ...
    if (targetPathExists && subcommandExists && !parsedArgs.flags["--cwd"] && !process.env.NOW_BUILDER && !wantsMachineReadableOutput(targetOrSubcommand, process.argv) && !await hasLocalProjectLink(client, cwd)) {
    ...
    if (user) {
      ...
      if (!related && !scopeMatchesUserIdentity) {
        try {
          ...
          output_manager_default.debug(
            `Direct team lookup for scope "${scope}" failed: ${(0, import_error_utils3.errorToString)(err)}`
          );
        }
      }
      if (related) {
